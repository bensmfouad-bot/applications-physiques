...
queue eulérien $S(H) - S_P(H) \approx C_H/(P \ln P)$. Trois objets sont
mesurés : (1) le point fixe infrarouge $S(H)$ ; (2) le flot de
renormalisation de la couplance adélique ; (3) le spectre FFT du résidu
eulérien sur $t \in [10, 50]$, en variable $\ln P$ (résolution
$\Delta t = 2\pi/\ln(10^3) \approx 0{,}91$, doctrine de l'Addendum XXXVII).
...
Prochaine pierre (rang II) : \texttt{dyadic\_renormalization.py}, le flot
de renormalisation sur l'arbre 2-adique (verres de spin, réseaux de
tenseurs).
